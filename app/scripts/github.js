...
function createThumbsupButton() {
  const rawHtml = `<md-thumbsup tabindex="-1" class="flex-auto text-center toolbar-item tooltipped tooltipped-nw p-1 mx-1" aria-label="Add a LGTM image" role="button">
